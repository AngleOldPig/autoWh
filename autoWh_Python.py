...
#需要填写的参数：
readFileName = 'cn_5934_muestras_todos_los_meses.csv'   #要读取的csv文档名
writeFileName = 'Comparativa_Susana.xlsx'               #需要录入的表格名
resultFileName = 'Comparativa_Susana-test.xlsx'         #保存结果的文档名


#加载参数文件
data1 = pd.read_csv(readFileName, encoding='utf-8')
data1["Production"] = data1["Production"] * 1000
data1.to_excel('somethingYouNeed.xlsx', sheet_name='Production')

wb1 = load_workbook('somethingYouNeed.xlsx')
wb2 = load_workbook(writeFileName)
